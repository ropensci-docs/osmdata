# DEPRECATED: Return an OSM Overpass query as an [osmdata](https://docs.ropensci.org/osmdata/reference/osmdata.md) object in sp format.

DEPRECATED: Return an OSM Overpass query as an
...
An object of class `osmdata` with the OSM components (points, lines, and
polygons) represented in sp format.
